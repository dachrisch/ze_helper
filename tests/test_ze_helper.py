...
from service.ze import WorkTimePage, ZE
...
class ZeHelperTest(unittest.TestCase):
    ...
    def test_iterate_weekdays(self):
        assert WorkTimePage.enumerate_workdays(2012, 12) == (
            3, 4, 5, 6, 7, 10, 11, 12, 13, 14, 17, 18, 19, 20, 21, 24, 25, 26, 27, 28,
            31), WorkTimePage.enumerate_workdays(
            2012, 12)

    def test_selective_days(self):
        assert WorkTimePage.enumerate_workdays(2012, 12, 7, 25) == (
            7, 10, 11, 12, 13, 14, 17, 18, 19, 20, 21, 24, 25), WorkTimePage.enumerate_workdays(2012, 12, 7, 25)
